...
char serviceUUID[] = "e5cfc525-435a-4458-8940-3e4f267d468f";
...
char characteristicUUID[] = "a5cfc525-435a-4458-8940-3e4f267d468f";
...
void setup() {
  ...
  while (!BLE.begin()) {
    ...
    delay(2000); //do nothing forever
  }

  BLE.setLocalName("Zongze's Arduino");
